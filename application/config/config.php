 ...
 * 
 * Any clones of OccupyTheSystem will need to update these things initially to run
 *****************************************************************************************/
//Base URL
//This keeps the base url out of the app. All references are built off of this.
//Put the URL of your local instance of OTS here. Don't forget the trailing slash
    define('URL', 'https://www.occupythesystem.org/');

//Database
//You'll need to load the DB schema from the repo into your local sql DB.
...
//Sunlight API Key
//Unfortunately for this you're going to have to get your own API key from the sunlight foundation:
//https://sunlightfoundation.com/api/accounts/register/
//NOTE: You will need to manually add this to an ajax call on public/ajax/getDistrict.php
    define('SUNLIGHT_API_KEY', '------------------------------');
    
    
//If you want to use the mail features (forgot password/activate account) you'll need
//to configure the SMTP settings below. Otherwise you can just do those things throught
//the database.
/*************************************************************************************
 *END INITIAL CONFIG - Everything below this doesn't need to be changed.
 *************************************************************************************/
...
define('COOKIE_DOMAIN', '.occupythesystem.org');

/**
 *MOVED TO INTIAL CONFIG SECTION
...
define("EMAIL_SMTP_USERNAME", 'mail@occupythesystem.org');
...
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "no-reply@OccupyTheSystem.org");
define("EMAIL_PASSWORD_RESET_FROM_NAME", "Occupy The System");
define("EMAIL_PASSWORD_RESET_SUBJECT", "Password reset for Occupy The System");
define("EMAIL_PASSWORD_RESET_CONTENT", "Please click on this link to reset your password: ");

define("EMAIL_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@OccupyTheSystem.org");
define("EMAIL_VERIFICATION_FROM_NAME", "Occupy The System");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Occupy The System");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
...
define("FEEDBACK_ADDRESS_FIELD_EMPTY", "Address field was empty.");
define("FEEDBACK_ADDRESS_FIELD_INVALID", "Address was not valid.<br />Please only use the street number and street name. Do not include unit numbers/letters.");
define("FEEDBACK_STATE_FIELD_EMPTY", "State field was empty.");
define("FEEDBACK_ZIPCODE_FIELD_EMPTY", "Zipcode field was empty.");
define("FEEDBACK_CITY_FIELD_EMPTY", "City field was empty.");
...
//Comunity Feedback
define("FEEDBACK_THREAD_EDITING_FAILED" , "Error editing thread.");
//Feedback on bills
define("FEEDBACK_STANCE_CREATION_FAILED", "There was an error adding your stance.");
define("FEEDBACK_STANCE_CREATION_FAILED_NO_STANCE", "Error: You must select a position to add a stance!");
define("FEEDBACK_STANCE_CREATION_FAILED_MISSING_INFO", "Error: You must fill out all the stance information before submitting!");
define("FEEDBACK_STANCE_DELETE_FAILED", "Hmm...we can't seem to find your stance. Delete failed.");
