...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		if(isTextarea || this.options.hasPanel) {
			...
			var s = {width: newX+'px', border : '1px solid #000', borderTop : 0, overflowY : 'auto', overflowX: 'hidden' };
...
var nicEditorPanel = bkClass.extend({
	construct : function(e,options,nicEditor) {
		...
		this.panelContain = new bkElement('DIV').setStyle({overflow : 'hidden', width : '100%', border : '1px solid #000', backgroundColor : '#efefef'}).addClass('panelContain');
